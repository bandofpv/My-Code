...
//Delay Variable
int fivesecDelay = 5000; //sets threesecDelay to 3 seconds
...
void setup() {
  ...
  //If the battery is greater than 3.8v
  if(batteryVoltage >= lowBattery && batteryVoltage <= highBattery){ 
    fanmotorOn(); //Turns fan motor on
  }
  delay(fivesecDelay); //5 second delay
}
